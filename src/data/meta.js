...
export const THREADS = [
 ...
 {id:"t8", emoji:"🏦", title:"Wenn Staaten versagen",
  sub:"Ein Argument, drei Baustellen",
  nodes:[
   {w:"Kap. 06", t:"Singer zur Armut", p:"Solange Staaten versagen, sind Individuen gefragt. Die Geburtsstunde des Arguments."},
   {w:"Kap. 10", t:"Individuelle Klimapflichten", p:"Der Staat sollte koordinieren, versagt aber. Also stellt sich die Frage: Was muss ICH tun, und was ist am wirksamsten?"},
   {w:"Kap. 11", t:"Demokratie reparieren", p:"Die Wurzel des Staatsversagens: vier Strukturprobleme. Reparaturvorschläge: Basisdemokratie ergänzend, Zukunftsräte."}]},
...
export const PLAN = [
 ...
 {d:"25.08.",w:"Di",h:"Kapitel 07 + 08 – Umwelt & Klima",m:"",
  t:["Lernpfad: Kapitel 07 und 08 komplett","Boss-Checks 07 und 08","Training: fällige Karten","Die vier Grundpositionen ordnen; VUP vs. NP mit Kritik"]},
 {d:"26.08.",w:"Mi",h:"Kapitel 10 + 11 – Klimapflichten & Demokratie",m:"Alle VL-Kapitel einmal durch",
  t:["Lernpfad: Kapitel 10 und 11 komplett","Boss-Checks 10 und 11","Training: fällige Karten","Die vier Demokratieprobleme und beide Reparaturen aufsagen"]},
